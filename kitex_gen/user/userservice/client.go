...
type Client interface {
	...
	CheckUserPresence(ctx context.Context, req *user.CheckUserPresenceRequest, callOptions ...callopt.Option) (r *user.CheckUserPresenceResponse, err error)
...
func (p *kUserServiceClient) CheckUserPresence(ctx context.Context, req *user.CheckUserPresenceRequest, callOptions ...callopt.Option) (r *user.CheckUserPresenceResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CheckUserPresence(ctx, req)
}
